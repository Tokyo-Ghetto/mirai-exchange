...
const Legal = () => {
  return (
    <LegalContainer>
      <LegalWrapper>
        <LegalTitle>Mirai Exchange Terms & Conditions</LegalTitle>
        <LegalText>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Mirai Exchange.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Mirai Exchange, accessible
                from{" "}
                <a
                  href="http://www.miraiexchange.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  http://www.miraiexchange.com
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: contact@miraiexchange.com</li>
          </ul>
        </LegalText>
      </LegalWrapper>
    </LegalContainer>
