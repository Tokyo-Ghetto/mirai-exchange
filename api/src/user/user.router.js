...
import { retrieveUserInfoCtrl, stockBuyController } from "./user.controller.js"; // importo los controllers del usuario
...
router
  .route("/") // defino una ruta en el router con su path
  .get(retrieveUserInfoCtrl); // asocio al get de ese path un controller
router.route("/buy").post(stockBuyController);
