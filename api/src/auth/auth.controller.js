...
export const registerUserController = (req, res) => {
  ...
  if (userInfo === undefined) {
    ...
    sendMail(
      email,
      "Verifica tu cuenta para seguir con el registro",
      `<a href="http://localhost:3000/validate-email?token=${tokenEmailVerification}">Verificar</a>`
    );
